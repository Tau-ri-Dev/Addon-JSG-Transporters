...
public class OriCPRaycaster extends AbstractCPRaycaster {
    ...
    public static final List<RayCastedButton> BUTTONS = List.of(
            new RayCastedButton(0, JSGTSymbolTypes.ORI, List.of(
            ...
            new RayCastedButton(1, JSGTSymbolTypes.ORI, List.of(
                    //Celestia
            ...
            new RayCastedButton(2, JSGTSymbolTypes.ORI, List.of(
                    //Radiance
            ...
            new RayCastedButton(3, JSGTSymbolTypes.ORI, List.of(
                    //Judgment
            ...
            new RayCastedButton(4, JSGTSymbolTypes.ORI, List.of(
                    //Chalice
            ...
            new RayCastedButton(5, JSGTSymbolTypes.ORI, List.of(
                    //Top right buttons
                    //Dominion
            ...
            new RayCastedButton(6, JSGTSymbolTypes.ORI, List.of(
                    //Harmony
            ...
            new RayCastedButton(7, JSGTSymbolTypes.ORI, List.of(
                    //Path
            ...
            new RayCastedButton(8, JSGTSymbolTypes.ORI, List.of(
                    //Oblivion
            ...
            new RayCastedButton(9, JSGTSymbolTypes.ORI, List.of(
                    //Serenity
            ...
            new RayCastedButton(10, JSGTSymbolTypes.ORI, List.of(
                    //Eternum
            ...
            new RayCastedButton(11, JSGTSymbolTypes.ORI, List.of(
            ...
            new RayCastedButton(12, JSGTSymbolTypes.ORI, List.of(
                    //Ascension
            ...
            new RayCastedButton(13, JSGTSymbolTypes.ORI, List.of(
                    //Salvation
            ...
            new RayCastedButton(14, JSGTSymbolTypes.ORI, List.of(
                    //Flame
            ...
            new RayCastedButton(15, JSGTSymbolTypes.ORI, List.of(
                    //Convergence
            ...
            new RayCastedButton(16, JSGTSymbolTypes.ORI, List.of(
                    //Vigil
            ...
            new RayCastedButton(17, JSGTSymbolTypes.ORI, List.of(
    ...
    public boolean testBlockState(BlockState blockState) {
        return blockState.is(JSGTBlocks.RINGS_CP_ORI.get());
    }
    ...
    protected boolean buttonClicked(Level level, Player player, int button, BlockPos pos, InteractionHand interactionHand) {
        ...
        JSGTPacketHandler.sendToServer(new CPButtonClickedToServer(pos, JSGTSymbolTypes.ORI.get().valueOf(button), false));
        return true;
    }
}
